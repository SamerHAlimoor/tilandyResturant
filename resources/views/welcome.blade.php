...
<section class="home" id="home">
  <div class=" swiper home-slilder">
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide" style="background: url({{URL::asset('assets/imges/0.jpg') }}) no-repeat  ;">
        <div class="content">
      ...
      <div class="swiper-slide slide" style="background: url({{URL::asset('assets/imges/331.jpg') }}) no-repeat ;">
        <div class="content">
          <span> ليس الوحدون لكن مميزون</span>
          <h3> مشروبــات</h3>
      ...
      <div class="swiper-slide slide" style="background: url({{URL::asset('assets/imges/home-slide-1.jpg') }}) no-repeat;">
        <div class="content">
          <span> ليس الوحدون لكن مميزون</span>
          <h3> حلويــات</h3>
...
<section class="about" id="about">
  <div class="imge">
<img src="{{URL::asset('assets/imges/about-img.png') }}" alt="">
  </div>
  <div class="content">
  ...
  <div class="icons-container">
    <div class="icons">
      <img src="{{URL::asset('assets/imges/about-icon-1.png') }}" alt="">
      <h3> الوجبات</h3>
    </div>
    <div class="icons">
      <img src="{{URL::asset('assets/imges/about-icon-2.png') }}" alt="">
      <h3>مشروبات</h3>
    </div>
  </div>
  </div>
  ...
  <div class=" swiper food-slider">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide" data-name="food-1">
        <img src="{{URL::asset('assets/imges/food-img-3.png') }}" alt="">
        <h3> وجبة دبوس</h3>
        <div class="price">₪18٫00</div>
      </div>
      <div class="swiper-slide slide" data-name="food-2">
        <img src="{{URL::asset('assets/imges/4.jpg') }}" alt="">
        <h3>سوري زنجر</h3>
        <div class="price">₪14٫00</div>
      </div>
      <div class="swiper-slide slide" data-name="food-3">
        <img src="{{URL::asset('assets/imges/78.jpg') }}" alt="">
        <h3> اسكلوب فاليه</h3>
        <div class="price">₪28٫00</div>
      </div>
      <div class="swiper-slide slide" data-name="food-4">
        <img src="{{URL::asset('assets/imges/213.jpg') }}" alt="">
        <h3>كبدة مقدسية </h3>
        <div class="price">₪18٫00</div>
      </div>
      <div class="swiper-slide slide" data-name="food-5">
        <img src="{{URL::asset('assets/imges/41.jpg') }}" alt="">
        <h3>وجبة كباب </h3>
        <div class="price">₪18٫00</div>
      </div>
    </div>
...
<section class="gallery" id="gallery" >
  ...
  <di class="gallery-container">
    <a href="{{URL::asset('assets/imges/food-galler-img-1.jpg')}}" class="boxs">
      <img src="{{URL::asset('assets/imges/food-galler-img-1.jpg') }}" alt="">
      <div class="icon"><i class="fas fa-plus"></i></div>
    </a>
    <a href="{{URL::asset('assets/imges/food-galler-img-2.jpg') }}" class="boxs">
      <img src="{{URL::asset('assets/imges/food-galler-img-2.jpg') }}" alt="">
      <div class="icon"><i class="fas fa-plus"></i></div>
    </a>
    <a href="{{URL::asset('assets/imges/food-galler-img-3.jpg') }}" class="boxs">
      <img src="{{URL::asset('assets/imges/food-galler-img-3.jpg') }}" alt="">
      <div class="icon"><i class="fas fa-plus"></i></div>
    </a>
    <a href="{{URL::asset('assets/imges/food-galler-img-4.jpg') }}" class="boxs">
      <img src="{{URL::asset('assets/imges/food-galler-img-4.jpg') }}" alt="">
      <div class="icon"><i class="fas fa-plus"></i></div>
    </a>
  
    <a href="{{URL::asset('assets/imges/food-galler-img-5.jpg') }}" class="boxs">
      <img src="{{URL::asset('assets/imges/food-galler-img-5.jpg') }}" alt="">
      <div class="icon"><i class="fas fa-plus"></i></div>
    </a>
  
    <a href="{{URL::asset('assets/imges/food-galler-img-6.jpg') }}" class="boxs">
      <img src="{{URL::asset('assets/imges/food-galler-img-6.jpg') }}" alt="">
      <div class="icon"><i class="fas fa-plus"></i></div>
    </a>
    ...
    <a href="{{URL::asset('assets/imges/food-galler-img-6.jpg') }}" class="boxs">
      <img src="{{URL::asset('assets/imges/5.1.png') }}" alt="">
      <div class="icon"><i class="fas fa-plus"></i></div>
    </a>
  </div>
  </div>
    ...
    <div class="box-container">
      <div class="box">
        <div class="inputBox">
          ...
          <input type="text" name="fullName" placeholder="أدخل أسمك" required>
        </div>
        <div class="inputBox">
          <span> الاسم الوجبة</span>
          <input type="text" name="nameofmeal"  placeholder="أدخل الوجبة التي تريدها" required>
        </div>
        <div class="inputBox">
          <span>  تفاصيل الطلب</span>
          <input type="text"  name="details" placeholder="أدخل تفاصيل طلبك   " required>
        </div>
        <div class="inputBox">
          <span> عنوانك </span>
          <textarea name="address" placeholder="أدخل العنوان الخاص بك " required id="" cols="30" rows="10"></textarea>
        </div>
      </div>
      <div class="box">
        <div class="inputBox">
          <span>  رقم الجوال/تليفون</span>
          <input type="number" name="phone" required placeholder="أدخل رقمك ">
        </div>
        <div class="inputBox">
          <span> الكمية </span>
          <input type="number" name="amount" required placeholder="   كم تريد">
        </div>
        <div class="inputBox">
          <span>  متي تريد طلبك </span>
          <input name="dateofmeal" required type="datetime-local">
        </div>
        <div class="inputBox">
          <span> عنواننا 
...
<section class=" blogs" id="blogs">
  ...
  <div class="inputBox">
    <span> الاسم الكامل</span>
    <input type="text" name="fullName" required placeholder="أدخل أسمك">
  </div>
  <div class="inputBox">
    <span> رقم الجوال</span>
    <input type="text" name="phone" required placeholder="أدخل رقمك">
  </div>
  <div class="inputBox">
    <span> إستفسارك </span>
    <textarea name="inquiry"  required placeholder="أدخل الاستفساراتك " id="" cols="30" rows="10"></textarea>
  </div>
  <button type="submit"  class="btn">إرسل الاستفسارات</button>
